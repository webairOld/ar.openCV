...
extern "C" {
JNIEXPORT void JNICALL Java_ch_bfh_bachelor_openCV_OpenCVView_FindFeatures(JNIEnv* env, jobject thiz, jint width, jint height, jbyteArray yuv, jintArray bgra)
{
